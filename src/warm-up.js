...
//------------------------- Variables -------------------------//
// nameOfArray[0].nameOfKeyFromObj 
...
var sequel = `${title} comes before The Simirilian.`;
...
if (pages < 1000) {
  ...
  return "Ok, maybe I could read that in a day adn a half."
}
...
var belowTwoHundred = [40, 8, 65, 37, 95, 56, 193, 34, 75, 3, 59, 34];
